...
│ .py      │               │ secret/myapp  │
└──────────┘               └───────────────┘
                            Seeded by scripts/setup/init_vault.ps1
```
...
**Files:** `.github/workflows/ci.yml`, `.github/workflows/deploy-aca.yml`
...
| `REGISTRY_USERNAME` | Registry username (GHCR, Docker Hub, or ACR) |
...
| `.github/workflows/deploy-aca.yml` | Manual ACA deployment workflow |
