...
if ($tests_failed -eq 0) {
    ...
    Write-Host "  - Vault sealed: Run unseal commands from TEST_GUIDE.md" -ForegroundColor White
    Write-Host "  - Missing packages: pip install -r backend/requirements.txt" -ForegroundColor White
