...
Write-Host "   .\scripts\testing\test.ps1" -ForegroundColor White
Write-Host ""

Write-Host "📖 Full Testing Guide:" -ForegroundColor Yellow
Write-Host "   See docs\guides\TEST_GUIDE.md for detailed testing instructions" -ForegroundColor White
Write-Host ""
