...
git add docs/reports/SECURITY_SCANNING.md docs/reports/SECURITY_REMEDIATION.md docs/guides/REBUILD_GUIDE.md
...
- Full scanning guide: `../reports/SECURITY_SCANNING.md`
- Detailed remediation report: `../reports/SECURITY_REMEDIATION.md`
