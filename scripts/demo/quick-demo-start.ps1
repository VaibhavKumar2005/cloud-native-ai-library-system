...
if (-not $SkipVault) {
    ...
    if ($vaultStatus -match "Sealed\s+false") {
        ...
        Write-Host "  Run: .\scripts\setup\init_vault.ps1 (requires API keys)" -ForegroundColor Cyan
...
& "$PROJECT_ROOT\scripts\demo\demo-health-check.ps1"
...
Write-Host ""
Write-Host "  📚 Full Demo Guide: See docs\guides\DEMO_GUIDE.md" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
